...
/***/ function(module, exports, __webpack_require__) {
  ...
  var Overlay = _react2['default'].createClass({
    ...
    render: function render() {
      ...
      console.log('overlay project', project, '/overlay project');
      return _react2['default'].createElement(
        'div',
      ...
      var projects = this.props.data.map(function (project, i) {
        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _this.state.showoverlay === project.name ? _react2['default'].createElement(_Overlay2['default'], { data: project }) : null,
            _this.state.showoverlay === project.name && _this.state.loading ? _react2['default'].createElement(
              'p',
              null,
              'Loading'
            ) : null
